...
- **⭐ 9 — Director ↔ fundamental "goblin" (the spine):** **✅ DONE** — **9a** `b4fe6020` (playtest PASSED 2026-06-05); **9c** Chunks 1+2 `0dbde359`, Chunk 3 `d3fbde97`, Chunk 4 source-switch (this commit; playtest PASSED 2026-06-09). Goblin spine complete — next work sits on this contract (4g/4f). *(Appendix G)*
