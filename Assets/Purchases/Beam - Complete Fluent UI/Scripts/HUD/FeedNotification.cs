...
namespace Michsky.UI.Beam
{
    ...
    public class FeedNotification : MonoBehaviour
    {
        ...
        {
            yield return new WaitForSeconds(BeamUIInternalTools.GetAnimatorClipLength(itemAnimator, "FeedNotification_In"));
            itemAnimator.enabled = false;
        }

        IEnumerator DisableItem()
        {
            yield return new WaitForSeconds(BeamUIInternalTools.GetAnimatorClipLength(itemAnimator, "FeedNotification_Out"));
