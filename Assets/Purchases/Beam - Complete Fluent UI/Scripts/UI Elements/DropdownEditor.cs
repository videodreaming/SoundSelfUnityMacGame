...
namespace Michsky.UI.Beam
{
    ...
    public class DropdownEditor : Editor
    {
        ...
        {
            BeamUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_Dropdown");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    BeamUIEditorHandler.DrawProperty(triggerObject, customSkin, "Trigger Object");
                    BeamUIEditorHandler.DrawProperty(headerText, customSkin, "Header Text");
                    BeamUIEditorHandler.DrawProperty(headerImage, customSkin, "Header Image");
                    ...
                    BeamUIEditorHandler.DrawProperty(scrollbar, customSkin, "Scrollbar");
                    BeamUIEditorHandler.DrawProperty(highlightCG, customSkin, "Highlight CG");
                    BeamUIEditorHandler.DrawProperty(contentCG, customSkin, "Content CG");
                    BeamUIEditorHandler.DrawProperty(listCG, customSkin, "List CG");
                    BeamUIEditorHandler.DrawProperty(listRect, customSkin, "List Rect");
                    break;

                case 2:
                    BeamUIEditorHandler.DrawHeader(customSkin, "Header_Customization", 6);
                    enableIcon.boolValue = BeamUIEditorHandler.DrawToggle(enableIcon.boolValue, customSkin, "Enable Header Icon");
                    ...
                    enableScrollbar.boolValue = BeamUIEditorHandler.DrawToggle(enableScrollbar.boolValue, customSkin, "Enable Scrollbar");
                    ...
                    startAtBottom.boolValue = BeamUIEditorHandler.DrawToggle(startAtBottom.boolValue, customSkin, "Start At Bottom");
                    useGamepadInput.boolValue = BeamUIEditorHandler.DrawToggle(useGamepadInput.boolValue, customSkin, "Use Gamepad Input");

                    BeamUIEditorHandler.DrawPropertyCW(itemSpacing, customSkin, "Item Spacing", 90);
                    ...
                    BeamUIEditorHandler.DrawProperty(panelDirection, customSkin, "Panel Direction");
                    BeamUIEditorHandler.DrawProperty(panelSize, customSkin, "Panel Size");
                    ...
                    initOnEnable.boolValue = BeamUIEditorHandler.DrawToggle(initOnEnable.boolValue, customSkin, "Initialize On Enable");
                    ...
                    enableTrigger.boolValue = BeamUIEditorHandler.DrawToggle(enableTrigger.boolValue, customSkin, "Enable Trigger", "Clicking outside will close the dropdown.");
                    ...
                    setHighPriority.boolValue = BeamUIEditorHandler.DrawToggle(setHighPriority.boolValue, customSkin, "Set High Priority");
                    ...
                    outOnPointerExit.boolValue = BeamUIEditorHandler.DrawToggle(outOnPointerExit.boolValue, customSkin, "Out On Pointer Exit", "Close the dropdown on pointer exit.");
                    useSounds.boolValue = BeamUIEditorHandler.DrawToggle(useSounds.boolValue, customSkin, "Use Sounds");
                 
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    saveSelected.boolValue = BeamUIEditorHandler.DrawTogglePlain(saveSelected.boolValue, customSkin, "Save Selected");                 
                    GUILayout.Space(3);

                    if (saveSelected.boolValue == true)
                    {
                        BeamUIEditorHandler.DrawPropertyPlainCW(saveKey, customSkin, "Save Key:", 66);
