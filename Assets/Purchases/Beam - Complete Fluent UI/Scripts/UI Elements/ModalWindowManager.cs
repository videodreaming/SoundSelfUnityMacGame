...
namespace Michsky.UI.Beam
{
    ...
    public class ModalWindowManager : MonoBehaviour
    {
        ...
        void InitModalWindow()
        {
            ...
            openStateLength = BeamUIInternalTools.GetAnimatorClipLength(mwAnimator, "ModalWindow_In");
            closeStateLength = BeamUIInternalTools.GetAnimatorClipLength(mwAnimator, "ModalWindow_Out");
        }
