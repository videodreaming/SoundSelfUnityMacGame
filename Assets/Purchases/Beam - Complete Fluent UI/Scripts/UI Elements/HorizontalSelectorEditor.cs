...
namespace Michsky.UI.Beam
{
    ...
    public class HorizontalSelectorEditor : Editor
    {
        ...
        {
            BeamUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_HorizontalSelector");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    BeamUIEditorHandler.DrawProperty(selectorAnimator, customSkin, "Animator");
                    BeamUIEditorHandler.DrawProperty(label, customSkin, "Label");
                    BeamUIEditorHandler.DrawProperty(labelHelper, customSkin, "Label Helper");
                    BeamUIEditorHandler.DrawProperty(labelIcon, customSkin, "Label Icon");
                    BeamUIEditorHandler.DrawProperty(labelIconHelper, customSkin, "Label Icon Helper");
                    BeamUIEditorHandler.DrawProperty(indicatorParent, customSkin, "Indicator Parent");
                    BeamUIEditorHandler.DrawProperty(indicatorObject, customSkin, "Indicator Object");
                    BeamUIEditorHandler.DrawProperty(contentLayout, customSkin, "Content Layout");
                    BeamUIEditorHandler.DrawProperty(contentLayoutHelper, customSkin, "Content Layout Helper");
                    break;
                ...
                case 2:
                    ...
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    enableIndicator.boolValue = BeamUIEditorHandler.DrawTogglePlain(enableIndicator.boolValue, customSkin, "Enable Indicators");
                    GUILayout.Space(3);
                    GUILayout.BeginHorizontal();
                    ...
                    BeamUIEditorHandler.DrawProperty(iconScale, customSkin, "Icon Scale");
                    BeamUIEditorHandler.DrawProperty(contentSpacing, customSkin, "Content Spacing");
                    GUI.enabled = true;
                    hsTarget.UpdateContentLayout();

                    BeamUIEditorHandler.DrawHeader(customSkin, "Header_Settings", 10);
                    invokeOnAwake.boolValue = BeamUIEditorHandler.DrawToggle(invokeOnAwake.boolValue, customSkin, "Invoke On Awake", "Process events on awake.");
                    invertAnimation.boolValue = BeamUIEditorHandler.DrawToggle(invertAnimation.boolValue, customSkin, "Invert Animation");
                    loopSelection.boolValue = BeamUIEditorHandler.DrawToggle(loopSelection.boolValue, customSkin, "Loop Selection");
                    ...
                    {
                        BeamUIEditorHandler.DrawPropertyCW(saveKey, customSkin, "Save Key:", 66);
