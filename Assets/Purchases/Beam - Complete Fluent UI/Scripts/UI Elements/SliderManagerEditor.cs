...
namespace Michsky.UI.Beam
{
    ...
    public class SliderManagerEditor : Editor
    {
        ...
        {
            BeamUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_Slider");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    BeamUIEditorHandler.DrawProperty(sliderObject, customSkin, "Slider Source");
                    if (showValue.boolValue == true) { BeamUIEditorHandler.DrawProperty(valueText, customSkin, "Label Text"); }
                ...
                case 2:
                    ...
                    usePercent.boolValue = BeamUIEditorHandler.DrawToggle(usePercent.boolValue, customSkin, "Use Percent");
                    showValue.boolValue = BeamUIEditorHandler.DrawToggle(showValue.boolValue, customSkin, "Show Label");
                    showPopupValue.boolValue = BeamUIEditorHandler.DrawToggle(showPopupValue.boolValue, customSkin, "Show Popup Label");
                    useRoundValue.boolValue = BeamUIEditorHandler.DrawToggle(useRoundValue.boolValue, customSkin, "Use Round Value");
