        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (buttonTarget.latestTabIndex)
            {
                case 0:
                    ...
                    BeamUIEditorHandler.DrawPropertyCW(state, customSkin, "Item State", 110);
                    ...
                    if (useCustomContent.boolValue == false)
                    {
                        if (buttonTarget.iconObj != null)
                        {
                            ...
                            enableIcon.boolValue = BeamUIEditorHandler.DrawTogglePlain(enableIcon.boolValue, customSkin, "Enable Icon");

                            GUILayout.Space(4);

                            if (enableIcon.boolValue == true)
                            {
                                BeamUIEditorHandler.DrawPropertyCW(buttonIcon, customSkin, "Button Icon", 110);
                            }
                        ...
                        if (buttonTarget.titleObj != null)
                        {
                            ...
                            enableTitle.boolValue = BeamUIEditorHandler.DrawTogglePlain(enableTitle.boolValue, customSkin, "Enable Title");

                            GUILayout.Space(4);

                            if (enableTitle.boolValue == true)
                            {
                                BeamUIEditorHandler.DrawPropertyCW(buttonTitle, customSkin, "Button Text", 110);
                        ...
                        if (buttonTarget.descriptionObj != null)
                        {
                            ...
                            enableDescription.boolValue = BeamUIEditorHandler.DrawTogglePlain(enableDescription.boolValue, customSkin, "Enable Description");

                            GUILayout.Space(4);

                            if (enableDescription.boolValue == true)
                            {
                                BeamUIEditorHandler.DrawPropertyCW(buttonDescription, customSkin, "Description", 110);
                        ...
                        if (buttonTarget.priceObj != null)
                        {
                            ...
                            enablePrice.boolValue = BeamUIEditorHandler.DrawTogglePlain(enablePrice.boolValue, customSkin, "Enable Price");

                            GUILayout.Space(4);

                            if (enablePrice.boolValue == true)
                            {
                                BeamUIEditorHandler.DrawPropertyCW(priceIcon, customSkin, "Price Icon", 110);
                                BeamUIEditorHandler.DrawPropertyCW(priceText, customSkin, "Price Text", 110);
                            }
                        ...
                        if (buttonTarget.filterObj != null)
                        {
                            ...
                            enableFilter.boolValue = BeamUIEditorHandler.DrawTogglePlain(enableFilter.boolValue, customSkin, "Enable Hover Filter");

                            GUILayout.Space(4);

                            if (enableFilter.boolValue == true)
                            {
                                BeamUIEditorHandler.DrawPropertyCW(backgroundFilter, customSkin, "Background Filter", 110);
                            }
                        ...
                        useModalWindow.boolValue = BeamUIEditorHandler.DrawTogglePlain(useModalWindow.boolValue, customSkin, "Use Modal Window");

                        GUILayout.Space(4);

                        if (useModalWindow.boolValue == true)
                        {
                            BeamUIEditorHandler.DrawPropertyCW(purchaseModal, customSkin, "Purchase Window", 110);
                        }
                ...
                case 1:
                    ...
                    BeamUIEditorHandler.DrawProperty(purchaseButton, customSkin, "Purchase Button");
                    BeamUIEditorHandler.DrawProperty(purchasedButton, customSkin, "Purchased Button");
                    BeamUIEditorHandler.DrawProperty(purchasedIndicator, customSkin, "Purchased Indicator");
                    ...
                    BeamUIEditorHandler.DrawProperty(priceObj, customSkin, "Price Object");
                    BeamUIEditorHandler.DrawProperty(priceIconObj, customSkin, "Price Icon Object");
                    BeamUIEditorHandler.DrawProperty(filterObj, customSkin, "Filter Object");
                    break;
