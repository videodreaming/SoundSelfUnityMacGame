...
namespace Michsky.UI.Beam
{
    ...
    public class ControllerManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            BeamUIEditorHandler.DrawProperty(presetManager, customSkin, "Preset Manager");
            BeamUIEditorHandler.DrawProperty(firstSelected, customSkin, "First Selected", "UI element to be selected first in the home panel (e.g. Play button).");
            ...
            alwaysUpdate.boolValue = BeamUIEditorHandler.DrawToggle(alwaysUpdate.boolValue, customSkin, "Always Update");
            affectCursor.boolValue = BeamUIEditorHandler.DrawToggle(affectCursor.boolValue, customSkin, "Affect Cursor", "Changes the cursor state depending on the controller state.");
