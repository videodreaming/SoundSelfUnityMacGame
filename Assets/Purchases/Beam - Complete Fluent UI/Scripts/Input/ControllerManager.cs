...
namespace Michsky.UI.Beam
{
    ...
    public class ControllerManager : MonoBehaviour
    {
        ...
        public List<ServerBrowserItem> serverItems = new List<ServerBrowserItem>();
        ...
        public void SwitchToGamepad()
        {
            ...
            for (int i = 0; i < modeSelectors.Count; i++) { if (modeSelectors[i] != null && !modeSelectors[i].useUINavigation) { modeSelectors[i].AddUINavigation(); } }
            for (int i = 0; i < serverItems.Count; i++) { if (serverItems[i] != null && !serverItems[i].useUINavigation) { serverItems[i].AddUINavigation(); } }
        ...
        public void SwitchToKeyboard()
        {
            ...
            for (int i = 0; i < modeSelectors.Count; i++) { if (modeSelectors[i] != null && !modeSelectors[i].useUINavigation) { modeSelectors[i].DisableUINavigation(); } }
            for (int i = 0; i < serverItems.Count; i++) { if (serverItems[i] != null && !serverItems[i].useUINavigation) { serverItems[i].DisableUINavigation(); } }
