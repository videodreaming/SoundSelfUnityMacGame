...
namespace Michsky.UI.Beam
{
    ...
    public class LocalizedObjectEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (EditorGUIUtility.isProSkin) { customSkin = BeamUIEditorHandler.GetDarkEditor(customSkin); }
            else { customSkin = BeamUIEditorHandler.GetLightEditor(customSkin); }

            if (loTarget.localizationSettings == null
                && Resources.Load<UIManager>("Beam UI Manager") != null
                && Resources.Load<UIManager>("Beam UI Manager").localizationSettings != null)
            {
                loTarget.localizationSettings = Resources.Load<UIManager>("Beam UI Manager").localizationSettings;
            }
        ...
        {
            BeamUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_Localization");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    BeamUIEditorHandler.DrawProperty(localizationSettings, customSkin, "Loc. Settings");
                    GUI.enabled = true;
                    ...
                    {
                        BeamUIEditorHandler.DrawProperty(audioObj, customSkin, "Audio Source");
                    }

                    else if (loTarget.objectType == LocalizedObject.ObjectType.Image)
                    {
                        BeamUIEditorHandler.DrawProperty(imageObj, customSkin, "Image Object");
                    }
                    ...
                    {
                        BeamUIEditorHandler.DrawHeader(customSkin, "Header_Tables", 10);
                ...
                case 1:
                    ...
                    rebuildLayoutOnUpdate.boolValue = BeamUIEditorHandler.DrawToggle(rebuildLayoutOnUpdate.boolValue, customSkin, "Rebuild Layout On Update", "Force to rebuild layout on item update to prevent visual glitches.");
                    break;
            }
