...
namespace Michsky.UI.Beam
{
    public class PauseMenuManager : MonoBehaviour
    {
        ...
        void Start()
        {
            if (panelManager != null) { disableAfter = BeamUIInternalTools.GetAnimatorClipLength(panelManager.panels[panelManager.currentPanelIndex].panelObject, "MainPanel_OutBottom"); }
