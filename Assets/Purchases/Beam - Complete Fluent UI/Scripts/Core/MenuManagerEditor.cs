...
namespace Michsky.UI.Beam
{
    ...
    public class MenuManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            BeamUIEditorHandler.DrawProperty(splashScreen, customSkin, "Splash Screen");
            BeamUIEditorHandler.DrawProperty(mainContent, customSkin, "Main Content");
            BeamUIEditorHandler.DrawProperty(initPanel, customSkin, "Init Screen");
