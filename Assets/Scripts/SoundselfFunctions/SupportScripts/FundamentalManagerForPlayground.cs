...
public class FundamentalManagerForPlayground : MonoBehaviour
{
    [SerializeField] private GameObject _fundamentalPrefab;
    public Action<Note> OnNewFundamentalSpawn;

    public ImitoneVoiceIntepreterForPlayground _voiceInterpreter;
    //public ExampleImitoneBehavior _voiceInterpreter;
    private HarmonyManagerForPlayground _harmonyManager;
    ...
    private void Awake()
    {
        _voiceInterpreter = GetComponent<ImitoneVoiceIntepreterForPlayground>();
        //_voiceInterpreter = GetComponent<ExampleImitoneBehavior>();
        _harmonyManager = GetComponent<HarmonyManagerForPlayground>();
