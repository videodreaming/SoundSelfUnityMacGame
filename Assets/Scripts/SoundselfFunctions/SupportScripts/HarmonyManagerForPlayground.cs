...
public class HarmonyManagerForPlayground : MonoBehaviour
{
    //TODO: testing
    ...
    private FundamentalManagerForPlayground _fundamentalManager;
 
    private void Awake()
    {
        _fundamentalManager = GetComponent<FundamentalManagerForPlayground>();
