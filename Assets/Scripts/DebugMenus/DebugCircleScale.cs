...
public class DebugCircleScale : MonoBehaviour
{
    ...
    void ScaleObjectNormalized()
    {
        ...
        Vector3 newScale = Vector3.Lerp(minScale, maxScale, GameValues.instance != null ? GameValues.instance._chantCharge : 0f);
