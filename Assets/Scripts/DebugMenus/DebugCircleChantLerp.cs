...
public class DebugCircleChantLerp : MonoBehaviour
{
    ...
    void ScaleObjectNormalized()
    {
        ...
        Vector3 newScale = Vector3.Lerp(minScale, maxScale, GameValues.instance != null ? GameValues.instance._chantLerpSlow : 0f);
