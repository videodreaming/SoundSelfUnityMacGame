...
public class DebugCircleChantLerpFastForPlayGround : MonoBehaviour
{
    // Start is called before the first frame update
    public ImitoneVoiceIntepreter ImitoneVoiceIntepreter;
    public GameValuesForPlayGround gameValuesForPlayGround;
    ...
    void ScaleObjectNormalized()
    {
        ...
        Vector3 newScale = Vector3.Lerp(minScale, maxScale, gameValuesForPlayGround._chantLerpFast);
