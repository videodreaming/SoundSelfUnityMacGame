...
namespace Michsky.UI.Beam
{
    ...
    public class LocalizationLanguageEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Info Header
            BeamUIEditorHandler.DrawHeader(customSkin, "Header_Content", 8);
            ...
            GUI.enabled = false;
            BeamUIEditorHandler.DrawProperty(languageID, customSkin, "Language ID");
            BeamUIEditorHandler.DrawProperty(languageName, customSkin, "Language Name");
            BeamUIEditorHandler.DrawProperty(localizedName, customSkin, "Localized Name");
            GUI.enabled = true;
