...
namespace Michsky.UI.Beam
{
    ...
    public class QuestItem : MonoBehaviour
    {
        ...
        {
            yield return new WaitForSeconds(BeamUIInternalTools.GetAnimatorClipLength(questAnimator, "QuestItem_In"));
            questAnimator.enabled = false;
        }

        IEnumerator DisableItem()
        {
            yield return new WaitForSeconds(BeamUIInternalTools.GetAnimatorClipLength(questAnimator, "QuestItem_Out"));
