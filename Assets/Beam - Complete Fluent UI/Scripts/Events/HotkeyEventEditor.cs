...
namespace Michsky.UI.Beam
{
    ...
    public class HotkeyEventEditor : Editor
    {
        ...
        {
            BeamUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_HotkeyEvent");
            ...
            switch (latestTabIndex)
            {
                case 0:
                    ...
                    BeamUIEditorHandler.DrawPropertyPlainCW(hotkeyType, customSkin, "Hotkey Type", 82);
                    ...
                    { 
                        ...
                        BeamUIEditorHandler.DrawProperty(controllerPreset, customSkin, "Default Preset");
                        if (labelObj.objectReferenceValue != null) { BeamUIEditorHandler.DrawProperty(hotkeyLabel, customSkin, "Hotkey Label"); }
                            ...
                            if (heTarget.showOutputOnEditor == true)
                            {
                                ...
                                for (int i = 0; i < heTarget.controllerPreset.items.Count; i++)
                                {
                                    if (heTarget.controllerPreset.items[i].itemID == heTarget.keyID)
                                    {
                                        ...
                                        else if (heTarget.controllerPreset.items[i].itemIcon != null) { GUILayout.Box(BeamUIEditorHandler.TextureFromSprite(heTarget.controllerPreset.items[i].itemIcon), GUILayout.Width(32), GUILayout.Height(32)); }
                                    }
                                }
                                GUI.enabled = true;
                            }
                    ...
                    BeamUIEditorHandler.DrawHeader(customSkin, "Header_Customization", 10);
                ...
                case 1:
                    ...
                    if (heTarget.hotkeyType == HotkeyEvent.HotkeyType.Dynamic)
                    {
                        BeamUIEditorHandler.DrawProperty(iconParent, customSkin, "Icon Parent");
                        BeamUIEditorHandler.DrawProperty(textParent, customSkin, "Text Parent");
                        BeamUIEditorHandler.DrawProperty(iconObj, customSkin, "Icon Object");
                        BeamUIEditorHandler.DrawProperty(labelObj, customSkin, "Label Object");
                ...
                case 2:
                    ...
                    BeamUIEditorHandler.DrawProperty(normalOpacity, customSkin, "Normal Opacity", "Sets the normal state (non-highlighted) opacity.");
