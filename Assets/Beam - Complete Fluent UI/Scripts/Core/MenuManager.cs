...
namespace Michsky.UI.Beam
{
    ...
    public class MenuManager : MonoBehaviour
    {
        ...
        void Initialize()
        {
            ...
            {
                Debug.LogError("<b>[Beam UI]</b> Cannot initialize the resources due to missing resources.", this);
                return;
            }
            ...
            if (UIManagerAsset.enableSplashScreen && UIManagerAsset.showSplashScreenOnce && GameObject.Find("[Beam UI - Splash Screen Helper]") != null)
            {
            ...
            if (UIManagerAsset.enableSplashScreen)
            {
                ...
                {
                    Debug.LogError("<b>[Beam UI]</b> Splash Screen is enabled but its resource is missing. Please assign the correct variable for 'Splash Screen'.", this);
                    return;
                }
                ...
                if (UIManagerAsset.showSplashScreenOnce)
                {
                    ...
                    tempHelper.name = "[Beam UI - Splash Screen Helper]";
            ...
            else
            {
                if (mainContent == null)
                {
                    Debug.LogError("<b>[Beam UI]</b> 'Main Panels' is missing. Please assign the correct variable for 'Main Panels'.", this);
                    return;
                }
