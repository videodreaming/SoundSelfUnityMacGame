...
namespace Michsky.UI.Beam
{
    ...
    public class NotificationManager : MonoBehaviour
    {
        ...
        {
            yield return new WaitForSeconds(BeamUIInternalTools.GetAnimatorClipLength(itemAnimator, "Notification_In"));
            itemAnimator.enabled = false;
        }

        IEnumerator DisableItem()
        {
            yield return new WaitForSeconds(BeamUIInternalTools.GetAnimatorClipLength(itemAnimator, "Notification_Out"));
