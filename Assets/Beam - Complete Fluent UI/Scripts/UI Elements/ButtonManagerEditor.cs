            ...
            switch (buttonTarget.latestTabIndex)
            {
                case 0:
                    ...
                    if (useCustomContent.boolValue == false)
                    {
                        if (buttonTarget.normalImageObj != null || buttonTarget.highlightImageObj != null)
                        {
                            ...
                            {
                                BeamUIEditorHandler.DrawPropertyCW(buttonIcon, customSkin, "Button Icon", 80);
                                BeamUIEditorHandler.DrawPropertyCW(iconScale, customSkin, "Icon Scale", 80);
                                if (enableText.boolValue == true) { BeamUIEditorHandler.DrawPropertyCW(spacing, customSkin, "Spacing", 80); }
                            }
                        ...
                        if (buttonTarget.normalTextObj != null || buttonTarget.highlightTextObj != null)
                        {
                            ...
                            enableText.boolValue = BeamUIEditorHandler.DrawTogglePlain(enableText.boolValue, customSkin, "Enable Text");

                            GUILayout.Space(4);

                            if (enableText.boolValue == true)
                            {
                                BeamUIEditorHandler.DrawPropertyCW(buttonText, customSkin, "Button Text", 80);
                                if (useCustomTextSize.boolValue == false) { BeamUIEditorHandler.DrawPropertyCW(textSize, customSkin, "Text Size", 80); }
                            }
                    ...
                    autoFitContent.boolValue = BeamUIEditorHandler.DrawTogglePlain(autoFitContent.boolValue, customSkin, "Auto-Fit Content", "Sets the width based on the button content.");
                ...
                case 1:
                    ...
                    if (enableText.boolValue == true)
                    {
                        ...
                        BeamUIEditorHandler.DrawProperty(highlightTextObj, customSkin, "Highlighted Text");
                        BeamUIEditorHandler.DrawProperty(disabledTextObj, customSkin, "Disabled Text");
                    }

                    if (enableIcon.boolValue == true)
                    {
                        BeamUIEditorHandler.DrawProperty(normalImageObj, customSkin, "Normal Icon");
                        BeamUIEditorHandler.DrawProperty(highlightImageObj, customSkin, "Highlight Icon");
                        BeamUIEditorHandler.DrawProperty(disabledImageObj, customSkin, "Disabled Icon");
                    }

                    BeamUIEditorHandler.DrawProperty(disabledLayout, customSkin, "Disabled Layout");
                    BeamUIEditorHandler.DrawProperty(normalLayout, customSkin, "Normal Layout");
                    BeamUIEditorHandler.DrawProperty(highlightedLayout, customSkin, "Highlighted Layout");
                    BeamUIEditorHandler.DrawProperty(mainLayout, customSkin, "Main Layout");

                    if (autoFitContent.boolValue == true)
                    {
                        BeamUIEditorHandler.DrawProperty(mainFitter, customSkin, "Main Fitter");
                        BeamUIEditorHandler.DrawProperty(targetFitter, customSkin, "Target Fitter");
                ...
                case 2:
                    ...
                    useCustomTextSize.boolValue = BeamUIEditorHandler.DrawToggle(useCustomTextSize.boolValue, customSkin, "Use Custom Text Size");
